...
void loop() {
  ...
  else if (soilValue < 400){//if the soil is too damp then make face express sickness
    sick();
    sick_move();
  }
  else if (400<soilValue<900 && tempValue > 80){ //if the soil is at a good moisutre level and the temperature is over 80 f then make face sweat
    hot();
    hot_move();
  }
